    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassExercises", x => x.ClassExerciseId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScoreId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubmissionId = table.Column<int>(type: "int", nullable: false),
                    Pronunciation = table.Column<double>(type: "float", nullable: true),
                    Grammar = table.Column<double>(type: "float", nullable: true),
                    LexicalResource = table.Column<double>(type: "float", nullable: true),
                    Coherence = table.Column<double>(type: "float", nullable: true),
