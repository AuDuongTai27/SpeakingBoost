namespace SpeakingBoost.Helpers
{
    public class BaseResponse<T>
    {
        ...
        public static BaseResponse<T> Fail(string message, List<string>? errors, int statusCode = 400) =>
            new() { Success = false, Message = message, Data = default, StatusCode = statusCode, Errors = errors };
    }
}
